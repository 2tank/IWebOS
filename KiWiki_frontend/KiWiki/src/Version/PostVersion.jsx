...
function PostVersion() {
  ...
  console.log('ID desde location:', id); // Verifica que el ID esté presente
  ...
  return (
    <>
      {loading ? (
        <div>Loading...</div> // Mostrar mientras se carga
      ) : (
            ...
            <div className="flex flex-col items-left mb-4">
              <div>
                ...
                <button type="button" onClick={() => setShowAddImage(!showAddImage)}>
                  {showAddImage ? <CancelImageIcon fontSize="large" className="cursor-pointer" /> :
